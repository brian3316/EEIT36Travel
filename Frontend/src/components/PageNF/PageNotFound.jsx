...
function PageNotFound() {
  ...
  return <div className='pagenotfound-box'>
      <div className='pagenotfound-content'>
        <svg className='pagenotfound-svg' width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="pagenotfound-text">
        <h1 className='pagenotfound-title'>404 Error</h1>  
         ...
         <h3>該網頁不存在
           <br />
           <a href="" className='pagenotfound-back-a' onClick={()=>navigate("/")}>返回首頁</a></h3> 
    </div>
  </div>;
}
